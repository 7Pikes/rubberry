...
describe Rubberry::Fields::Object do
  ...
  describe '#type_cast', time_freeze: '2014-10-29T08:30:05.124' do
  ...
  describe '#elasticize', time_freeze: '2014-10-29T08:30:05.124' do
    ...
    specify{ expect(subject.type_cast(
      ...
      'title' => 'Title', 'created_at' => '2014-10-29T08:30:05.124', 'author' => { 'name' => 'Undr' }
    ) }
  end
end
